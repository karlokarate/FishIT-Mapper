    ...
    class ContractGenerator(
        ...
        private fun valParam(
            ...
            val b = ParameterSpec.builder(name, type).addModifiers(KModifier.VAL)
            if (defaultValue != null) b.defaultValue(defaultValue)
            return b.build()
        }

        private fun overrideValParam(
            name: String,
            type: TypeName,
            defaultValue: CodeBlock? = null
        ): ParameterSpec {
            val b = ParameterSpec.builder(name, type).addModifiers(KModifier.OVERRIDE, KModifier.VAL)
            if (defaultValue != null) b.defaultValue(defaultValue)
            return b.build()
        }
        ...
        private fun generatedFile(name: String): FileSpec.Builder =
            FileSpec.builder(pkg, name)
                .addComment("GENERATED by FishIT-Mapper KotlinPoet generator. DO NOT EDIT.")
                .addAnnotation(
...
", ClassName(pkg, "ContractInfo"))
        ...
        private fun generateIds(): FileSpec {
                ...
                return TypeSpec.classBuilder(name)
                    ...
                    .primaryConstructor(
                        FunSpec.constructorBuilder()
                            .addParameter(valParam("value", string))
                            .build()
                    )
                    .build()
            }
            ...
            val mapAlias = TypeSpec.typeAliasBuilder("Attributes", mapStringString)
        ...
        private fun generateRecorder(): FileSpec {
            ...
            fun dataEvent(
                ...
                val ctor = FunSpec.constructorBuilder()
                    .addParameter(overrideValParam("id", eventId))
                    .addParameter(overrideValParam("at", instant))
